...
const OnboardingProgressIndicator = dynamic(() => import("./components/OnboardingProgressIndicator"));
const AddJMESCard = dynamic(() => import("./components/AddJMESCard"));
const AddTokensCard = dynamic(() => import("./components/AddTokensCard"));
const ChooseUsernameCard = dynamic(() => import("./components/ChooseUsernameCard"));
const ConnectWalletCard = dynamic(() => import("./components/ConnectWalletCard"));
