...
export const DelegateUnbondingTable = () => {
  return (
    <TableContainer height={320} overflowY="scroll">
        <Table variant="unstyled" size="sm" color="#fff">
            <Thead>
                <Tr>
                <Th textTransform="none" paddingLeft={0} position="sticky" top={0} background="#5136C2">
                    <Text
                    color="lilac"
                    fontFamily={"DM Sans"}
                    fontWeight="500"
                ...
                <Th textTransform="none" paddingRight={0} position="sticky" top={0} background="#5136C2">
                    <Text
                    color="lilac"
                    fontFamily={"DM Sans"}
                    fontWeight="500"
