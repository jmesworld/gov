...
export function useIdentityserviceRegisterUserMutation(options?: Omit<UseMutationOptions<WaitTxBroadcastResult, Error, IdentityserviceRegisterUserMutation>, "mutationFn">) {
  return useMutation<WaitTxBroadcastResult, Error, IdentityserviceRegisterUserMutation>(({
    client,
    msg,
    args: {
      coins
