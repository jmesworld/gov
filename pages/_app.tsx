...
import jmesPicasso from '../config/chains/jmes-picasso/chain.json';
...
import jmesPicassoAssets from '../config/chains/jmes-picasso/assetlist.json';
...
const chains: Chain[] = [jmesTestnet, jmesNamito, jmesPicasso];
const assets = [jmesAssets, jmesNamitoAssets, jmesPicassoAssets];
