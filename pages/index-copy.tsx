...
export default function Home() {
  ...
  const [identityBalance, setIdentityBalance] = useState<any>();
  ...
  const [userHasIdentity, setUserHasIdentity] = useState(false);
  ...
  useEffect(() => {
    ...
    if (identityOwnerQuery.isSuccess) {
      setUserHasIdentity(true);
    } else {
      setUserHasIdentity(false);
    }
  }, []);
